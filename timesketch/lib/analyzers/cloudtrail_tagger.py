"""Sketch analyzer plugin for cloudtrail tagger."""
...
class CloudtrailTaggerSketchPlugin(interface.BaseSketchAnalyzer):
    """Sketch analyzer for CloudtrailTagger."""

    NAME = 'cloudtrail_tagger'
    ...
    def __init__(self, index_name, sketch_id):
        ...
        super(CloudtrailTaggerSketchPlugin, self).__init__(
...
manager.AnalysisManager.register_analyzer(CloudtrailTaggerSketchPlugin)
